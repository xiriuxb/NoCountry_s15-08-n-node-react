...
export default class TipsHelper {
    ...
    tipSchema = z.object({
        ...
        description: z
            .string({
                invalid_type_error: `La descripción debe contener como maximo 500 caracteres.`,
                required_error: `Descripción invalida, supero el maximo de caracteres permitido.`
            })
    ...
    public verifyTips = (
        tips: any
    ): { success: true; data: Tips } | { success: false; error: ZodError<any> } => {
        try {
