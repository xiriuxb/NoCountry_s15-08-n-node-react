...
Best if yu can read the docs and familiarize with some definitions
*/
...
In this abroach we can reference an schema manually like JS normal code, or with $ref (using this avoid us to import objects)
            ...
            properties: {
                field_name: {
                    ...
                    properties: {
                        ...
                        location: {
                            type: 'string',
                            description: 'La locación del campo',
                            example: 'body'
                        },
                        path: {
                            type: 'string',
