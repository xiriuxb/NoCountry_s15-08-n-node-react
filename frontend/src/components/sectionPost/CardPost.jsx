...
const CardPost = () => {
  return (
    <div className="bg-black w-[450px] h-[300px] rounded-lg p-2">
        ...
        <div className="w-[40%] h-full flex flex-col">
          <div className="w-full h-full flex flex-col">
            <div className="w-full h-full flex p-1">
              ...
              <div>
                <h4 className="text-white m-1">Sara</h4>
          ...
          <div className="w-full h-full p-1">
            <div className="w-full h-full  p-1 flex flex-col justify-center items-center">
              <div className="w-full h-auto flex justify-between">
                <p className="text-white text-[8px] m-1">
                  Mas publicaciones de Sara
                </p>
                <p className="text-white text-[8px] m-1">20 Post</p>
              </div>
        ...
        <div className="w-[60%] h-full  p-1">
          <div className="w-full h-full p-1">
            ...
            <div className="w-full h-[30%] p-1">
              <div className="w-full h-[30%] text-sm flex justify-start items-center space-x-2 ">
                <FiMessageCircle />
