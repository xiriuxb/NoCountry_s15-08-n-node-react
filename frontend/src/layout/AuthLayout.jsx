  ...
  return (
    <>
      {isAuth ? (
        ...
        <main className="flex w-full bg-black h-screen overflow-hidden">
          <div className="flex flex-row w-1/2 relative ml-60">
            <img src="/canadepesca.png" className="w-full" />
            <div className="absolute">
              <Link to={"/"}>
                <h1 className="text-6xl font-playfair text-white p-6 pb-96 mb-12">
                  FishSeason
                </h1>
              </Link>
              <h3 className="text-4xl font-playfair justify-left text-white w-2/3 pt-96 p-6">
